# -*- coding: utf-8 -*-
"""
Created on Sat Dec 18 14:45:52 2021
...
class super:
    ...
    def calculate_price(self):
        ...
        self.button_4=Button(text="اغلاق البرنامج",bg=self.color_button,width=10,borderwidth=2,cursor="hand2",font=("arial",13,"bold"),command=qexit).place(x=1110,y=660)
