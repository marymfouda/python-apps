...
class super:
    ...
    def drink(self):
      ...
      #row2
        ...
        # self.textinput1=Entry(self.window,width=20,bg=self.fontcolor,textvariable=self.value_input1,justify='center')
        ...
        self.textinput1 = Entry(self.f11,width=20,textvariable=self.value_input1,justify='center')
        
        
        self.textinput1.pack()
        self.textinput1.place(x=290,y=50)
        placeholder_text = '<enter-placeholder>'
        self.textinput1.insert(0, placeholder_text)
        ...
        placeholder_text = '<enter-placeholder>'
        self.textinput2.insert(0, placeholder_text)
