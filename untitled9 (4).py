...
class super:
    ...
    def calculate_drink(self):
        ...
        self.totalall = self.total +self.total2 + self.total3
    def drink2(self):
    ...
    def billing(self):
        if self.name_store.get()=="" or self.phone_store.get()=="":
            ...
            if self.value_input1aa.get()!=0:
                 self.txtarea.insert(END,f"\n {self.price1a}\t\t{self.value_input1a.get()}\thot oate")
            if self.value_input2aa.get()!=0:
                self.txtarea.insert(END,f"\n {self.price2a}\t\t{self.value_input2a.get()}\thot lotus")
            if self.value_input3aa.get()!=0:
                self.txtarea.insert(END,f"\n {self.price3a}\t\t{self.value_input3a.get()}\thot chocolate marshmllow")
            if self.value_input4aa.get()!=0:
                self.txtarea.insert(END,f"\n {self.price4a}\t\t{self.value_input4a.get()}\thot chocolate ")
