...
class super:
    ...
    def calculate_price(self):
        ...
        self.button_4=Button(window,text="اغلاق البرنامج",bg=self.color_button,width=10,borderwidth=2,cursor="hand2",font=("arial",13,"bold"),command=quit).place(x=1110,y=660)
